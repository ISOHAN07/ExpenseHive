      ...
      >
        <div className="p-6 border-b border-sidebar-border flex items-center justify-between">
          ...
          >
            ...
            <span className="font-bold text-lg text-sidebar-foreground cursor-pointer">
              ExpenseHive
            </span>
          </button>
          <button
        ...
        <div className="p-4 border-t border-sidebar-border space-y-2">
          ...
          <button
            ...
            className={cn(
              "flex items-center gap-3 px-4 py-3 w-full rounded-lg cursor-pointer transition-colors text-left",
              "text-sidebar-foreground hover:bg-sidebar-accent"
            )}
          >
